...
from models import IHerbProducts, IHerbPrices
...
class IHerbProductsCrud(ProductsCrud):
    def __init__(self, session: Session):
        super().__init__(session, IHerbProducts)


class IHerbPricesCrud(PricesCrud):
    def __init__(self, session: Session):
        super().__init__(session, IHerbPrices)
